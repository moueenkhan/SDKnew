...
try
{
    ResponseQueries result = await queriesController.QueryDetailsAsync(authorization, contentType, queryId);
}
catch (ApiException e){};
```
...
| `authorization` | `string` | Header, Required | Bearer AccessToken |
| `queryId` | `string` | Template, Required | Query id |
| `body` | [`Models.QueriesUpdateSchema`](../../doc/models/queries-update-schema.md) | Body, Required | - |
...
string authorization = "Authorization8";
string queryId = "queryId6";
var body = new QueriesUpdateSchema();

try
{
    ResponseQueries result = await queriesController.UpdateQueriesAsync(authorization, queryId, body);
}
catch (ApiException e){};
```
...
try
{
    await queriesController.DeleteQueriesAsync(authorization, contentType, queryId);
}
catch (ApiException e){};
```
