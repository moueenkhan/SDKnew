...
namespace LaceworkAPI20Documentation.Standard
{
    ...
    public sealed class LaceworkAPI20DocumentationClient : IConfiguration
    {
        ...
        private readonly Lazy<PoliciesController> policies;
        private readonly Lazy<QueriesController> queries;
            ...
            IHttpClientConfiguration httpClientConfiguration)
        {
            ...
            this.policies = new Lazy<PoliciesController>(
                () => new PoliciesController(this, this.httpClient, this.authManagers));
            this.queries = new Lazy<QueriesController>(
                () => new QueriesController(this, this.httpClient, this.authManagers));
        ...
        /// <summary>
        /// Gets PoliciesController controller.
        /// </summary>
        public PoliciesController PoliciesController => this.policies.Value;

        /// <summary>
        /// Gets QueriesController controller.
        /// </summary>
        public QueriesController QueriesController => this.queries.Value;
