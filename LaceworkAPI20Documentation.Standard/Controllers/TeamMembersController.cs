...
namespace LaceworkAPI20Documentation.Standard.Controllers
{
    ...
    public class TeamMembersController : BaseController
    {
        ...
        public Models.ResponseTeamMembers CreateTeamMembers(
                ...
                bool? orgAccess = null)
        {
            Task<Models.ResponseTeamMembers> t = this.CreateTeamMembersAsync(authorization, body, orgAccess);
        ...
        {
            Task<Models.ResponseTeamMembersList> t = this.SearchTeamMembersAsync(authorization, body);
            ApiHelper.RunTaskSynchronously(t);
            return t.Result;
        }
        ...
        public Models.ResponseUpdateTeamMember UpdateTeamMember(
                ...
                bool? orgAccess = null)
        {
            Task<Models.ResponseUpdateTeamMember> t = this.UpdateTeamMemberAsync(authorization, userGuid, body, orgAccess);
            ApiHelper.RunTaskSynchronously(t);
            return t.Result;
        }
