...
namespace LaceworkAPI20Documentation.Standard.Controllers
{
    ...
    public class CloudAccountsController : BaseController
    {
        ...
        public Models.ResponseCloudAccounts CreateCloudAccounts(
                ...
                object body)
        {
            Task<Models.ResponseCloudAccounts> t = this.CreateCloudAccountsAsync(authorization, body);
        ...
        {
            Task<Models.ResponseCloudAccountsList> t = this.SearchCloudAccountsAsync(authorization, body);
            ApiHelper.RunTaskSynchronously(t);
            return t.Result;
        }
        ...
        public Models.ResponseCloudAccounts UpdateCloudAccounts(
                ...
                object body)
        {
            Task<Models.ResponseCloudAccounts> t = this.UpdateCloudAccountsAsync(authorization, intgGuid, body);
            ApiHelper.RunTaskSynchronously(t);
            return t.Result;
        }
