...
namespace LaceworkAPI20Documentation.Standard.Controllers
{
    ...
    public class ReportRulesController : BaseController
    {
        ...
        {
            Task<Models.ResponseReportRules> t = this.CreateReportRuleAsync(authorization, body);
        ...
        {
            Task<Models.ResponseReportRulesList> t = this.SearchReportRulesAsync(authorization, body);
            ApiHelper.RunTaskSynchronously(t);
            return t.Result;
        }
        ...
        {
            Task<Models.ResponseReportRules> t = this.UpdateReportRulesAsync(authorization, mcGuid, body);
            ApiHelper.RunTaskSynchronously(t);
            return t.Result;
        }
