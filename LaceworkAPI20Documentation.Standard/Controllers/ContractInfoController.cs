// <copyright file="ContractInfoController.cs" company="APIMatic">
...
namespace LaceworkAPI20Documentation.Standard.Controllers
{
    ...
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ContractInfoController"/> class.
        /// </summary>
        /// <param name="config"> config instance. </param>
        /// <param name="httpClient"> httpClient. </param>
        /// <param name="authManagers"> authManager. </param>
        internal ContractInfoController(IConfiguration config, IHttpClient httpClient, IDictionary<string, IAuthManager> authManagers)
        ...
        /// <returns>Returns the Models.ResponseContractInfoList response from the API call.</returns>
        public Models.ResponseContractInfoList ContractInfo(
                string authorization,
                string contentType)
        {
            Task<Models.ResponseContractInfoList> t = this.ContractInfoAsync(authorization, contentType);
        ...
        /// <returns>Returns the Models.ResponseContractInfoList response from the API call.</returns>
        public async Task<Models.ResponseContractInfoList> ContractInfoAsync(
                string authorization,
                string contentType,
                CancellationToken cancellationToken = default)
        {
            ...
            queryBuilder.Append("/api/v2/ContractInfo");
            ...
            return ApiHelper.JsonDeserialize<Models.ResponseContractInfoList>(response.Body);
        }
    }
}