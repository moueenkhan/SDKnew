// <copyright file="PoliciesController.cs" company="APIMatic">
...
namespace LaceworkAPI20Documentation.Standard.Controllers
{
    ...
    public class PoliciesController : BaseController
    {
        ...
        internal PoliciesController(IConfiguration config, IHttpClient httpClient, IDictionary<string, IAuthManager> authManagers)
        ...
        /// <returns>Returns the Models.ResponsePolicies response from the API call.</returns>
        public Models.ResponsePolicies CreatePolicies(
                string authorization,
                Models.PoliciesCreateSchema body)
        {
            Task<Models.ResponsePolicies> t = this.CreatePoliciesAsync(authorization, body);
        ...
        /// <returns>Returns the Models.ResponsePolicies response from the API call.</returns>
        public async Task<Models.ResponsePolicies> CreatePoliciesAsync(
                string authorization,
                Models.PoliciesCreateSchema body,
                CancellationToken cancellationToken = default)
        {
            ...
            queryBuilder.Append("/api/v2/Policies");
            ...
            return ApiHelper.JsonDeserialize<Models.ResponsePolicies>(response.Body);
        }
        ...
        /// <returns>Returns the Models.ResponsePoliciesList response from the API call.</returns>
        public Models.ResponsePoliciesList ListAllPolicies(
                string authorization,
                string contentType)
        {
            Task<Models.ResponsePoliciesList> t = this.ListAllPoliciesAsync(authorization, contentType);
            ApiHelper.RunTaskSynchronously(t);
            return t.Result;
        }
        ...
        /// <param name="cancellationToken"> cancellationToken. </param>
        /// <returns>Returns the Models.ResponsePoliciesList response from the API call.</returns>
        public async Task<Models.ResponsePoliciesList> ListAllPoliciesAsync(
                string authorization,
                string contentType,
                CancellationToken cancellationToken = default)
        {
            ...
            return ApiHelper.JsonDeserialize<Models.ResponsePoliciesList>(response.Body);
        }
        ...
        /// <param name="authorization">Required parameter: Bearer AccessToken.</param>
        /// <param name="contentType">Required parameter: application/json.</param>
        /// <param name="policyId">Required parameter: Policy id.</param>
        /// <returns>Returns the Models.ResponsePolicies response from the API call.</returns>
        public Models.ResponsePolicies PoliciesDetails(
                string authorization,
                string contentType,
                string policyId)
        {
            Task<Models.ResponsePolicies> t = this.PoliciesDetailsAsync(authorization, contentType, policyId);
            ApiHelper.RunTaskSynchronously(t);
            return t.Result;
        }
        ...
        /// <param name="cancellationToken"> cancellationToken. </param>
        /// <returns>Returns the Models.ResponsePolicies response from the API call.</returns>
        public async Task<Models.ResponsePolicies> PoliciesDetailsAsync(
                string authorization,
                string contentType,
                string policyId,
                CancellationToken cancellationToken = default)
        {
            ...
            // prepare query string for API call.
            StringBuilder queryBuilder = new StringBuilder(baseUri);
            queryBuilder.Append("/api/v2/Policies/{policyId}");
        ...
        /// <param name="body">Required parameter: Example: .</param>
        /// <returns>Returns the Models.ResponsePolicies response from the API call.</returns>
        public Models.ResponsePolicies UpdatePolicies(
                string authorization,
                string policyId,
                Models.PoliciesUpdateSchema body)
        {
            Task<Models.ResponsePolicies> t = this.UpdatePoliciesAsync(authorization, policyId, body);
            ApiHelper.RunTaskSynchronously(t);
            return t.Result;
        }
        ...
        /// <param name="cancellationToken"> cancellationToken. </param>
        /// <returns>Returns the Models.ResponsePolicies response from the API call.</returns>
        public async Task<Models.ResponsePolicies> UpdatePoliciesAsync(
                string authorization,
                string policyId,
                Models.PoliciesUpdateSchema body,
                CancellationToken cancellationToken = default)
        ...
        public void DeletePolicies(
                ...
                string policyId)
        {
            Task t = this.DeletePoliciesAsync(authorization, contentType, policyId);
            ApiHelper.RunTaskSynchronously(t);
        }
        ...
        public async Task DeletePoliciesAsync(
                string authorization,
                string contentType,
                string policyId,
                CancellationToken cancellationToken = default)
