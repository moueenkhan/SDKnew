...
namespace LaceworkAPI20Documentation.Standard.Controllers
{
    ...
    public class ResourceGroupsController : BaseController
    {
        ...
        public Models.ResponseResourceGroups CreateResourceGroup(
                ...
                object body)
        {
            Task<Models.ResponseResourceGroups> t = this.CreateResourceGroupAsync(authorization, body);
        ...
        {
            Task<Models.ResponseResourceGroupsList> t = this.SearchResourceGroupsAsync(authorization, body);
            ApiHelper.RunTaskSynchronously(t);
            return t.Result;
        }
        ...
        public Models.ResponseResourceGroups UpdateResourceGroups(
                ...
                object body)
        {
            Task<Models.ResponseResourceGroups> t = this.UpdateResourceGroupsAsync(authorization, resourceGuid, body);
            ApiHelper.RunTaskSynchronously(t);
            return t.Result;
        }
