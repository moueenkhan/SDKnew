...
namespace LaceworkAPI20Documentation.Standard.Controllers
{
    ...
    public class AlertRulesController : BaseController
    {
        ...
        {
            Task<Models.ResponseAlertRules> t = this.CreateAlertRulesAsync(authorization, body);
        ...
        {
            Task<Models.ResponseAlertRulesList> t = this.SearchAlertRulesAsync(authorization, body);
            ApiHelper.RunTaskSynchronously(t);
            return t.Result;
        }
        ...
        {
            Task<Models.ResponseAlertRules> t = this.UpdateAlertRulesAsync(authorization, mcGuid, body);
            ApiHelper.RunTaskSynchronously(t);
            return t.Result;
        }
