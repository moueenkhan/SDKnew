// <copyright file="YapstoneStagedOnBoardingServicesClient.cs" company="APIMatic">
...
namespace YapstoneStagedOnBoardingServices.Standard
{
    ...
    using YapstoneStagedOnBoardingServices.Standard.Controllers;
    ...
    /// </summary>
    public sealed class YapstoneStagedOnBoardingServicesClient : IConfiguration
    {
        ...
        private YapstoneStagedOnBoardingServicesClient(
            ...
            IHttpClientConfiguration httpClientConfiguration)
        {
            ...
            this.instruments = new Lazy<InstrumentsController>(
                () => new InstrumentsController(this, this.httpClient, this.authManagers));
        ...
        public string GetBaseUri(Server alias = Server.Server3)
        {
        ...
        /// <summary>
        /// Creates an object of the YapstoneStagedOnBoardingServicesClient using the values provided for the builder.
        /// </summary>
        ...
        /// </summary>
        /// <returns> YapstoneStagedOnBoardingServicesClient.</returns>
        internal static YapstoneStagedOnBoardingServicesClient CreateFromEnvironment()
        {
            var builder = new Builder();

            string environment = System.Environment.GetEnvironmentVariable("YAPSTONE_STAGED_ON_BOARDING_SERVICES_STANDARD_ENVIRONMENT");
            string authorization = System.Environment.GetEnvironmentVariable("YAPSTONE_STAGED_ON_BOARDING_SERVICES_STANDARD_AUTHORIZATION");
        ...
        {
            private Environment environment = YapstoneStagedOnBoardingServices.Standard.Environment.Production;
            ...
            /// </summary>
            /// <returns>YapstoneStagedOnBoardingServicesClient.</returns>
            public YapstoneStagedOnBoardingServicesClient Build()
            {
                this.httpClient = new HttpClientWrapper(this.httpClientConfig.Build());

                return new YapstoneStagedOnBoardingServicesClient(
                    this.environment,
                    this.authorization,
                    this.authManagers,
                    this.httpClient,
